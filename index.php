...
<body>
  <div class="title">
    <h1> Rakan Hussein</h1>
    <h5 style="text-align:center;color: #ffce52;">Full Stack Web Developer</h5>
  </div>
  <div class="" style="margin-top:25rem;">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path fill="black" fill-opacity="1" d="M0,256L80,213.3C160,171,320,85,480,90.7C640,96,800,192,960,218.7C1120,245,1280,203,1360,181.3L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
    </svg>
    <div style="background-color:black;">
      <div class="container main">
        <h1>projects</h1>
        <div class="row container">
          <div class="col glow box">
            <span></span>
              <span></span>
              <span></span>
              <span></span>
